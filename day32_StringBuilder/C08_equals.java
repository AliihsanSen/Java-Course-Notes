...
public class C08_equals {
    ...
    public static void main(String[] args) {
        ...
        /*
        --> StringBuilder'da equals method'u ancak ayni pbje olursa true doner.
        --> String'deki gibi dusunmemek lazim.
         */

        System.out.println(sb1.equals(str)); // false

        String str1 = sb1.toString().toUpperCase();
        ...
        /*
        compareTo(9 iki StringBuilder'i bastan baslayarak harf harf karşilaştiri.
        ...
        eger hic farkli harf yoksa sonuc olarak o dondurur.
         */
