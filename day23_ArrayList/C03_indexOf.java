...
public class C03_indexOf {
    ...
    public static void main(String[] args) {
        ...
        /*
        indexOf method'u bize bilgi donduren bir method'dur. listemizi
         */
        ...
        lastIndexOf method'u ise aramaya sın index'den baslar.

        arama bitip, urun bulundugunnda ikisi de bulunan urunun index'ini verir.
         */
